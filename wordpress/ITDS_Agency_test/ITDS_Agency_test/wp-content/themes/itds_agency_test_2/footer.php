	...
	<footer>
		<div class="footer-logo">
			...
			<div class="footer__block-icon">
				<div class="block-icon"><a href="#"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/icons_inst.png') ?>" alt=""></a></div>
				<div class="block-icon"><a href="#"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/icons_fb.png') ?>" alt=""></a></div>
			</div>
		</div>
		...
		<div class="footer-contacts">
			...
			<div class="footer-contacts__text">
				<a href="#">
					<span class="footer-contacts__text-row">
						<span class="block-icon">
							<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/icon-telephone.png') ?>" alt="">
						</span>
				...
				<a href="#">
					<span class="footer-contacts__text-row">
						<span class="block-icon">
							<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/icon-maile.png') ?>" alt="">
						</span>
				...
				<a href="<?php echo esc_url($ITDS_Agency_options['contact_map-link']); ?>">
					<span class="footer-contacts__text-row">
						<span class="block-icon">
							<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/icon-map.png') ?>" alt="">
						</span>

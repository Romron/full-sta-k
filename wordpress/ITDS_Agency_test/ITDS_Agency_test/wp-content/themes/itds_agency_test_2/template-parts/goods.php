				...
				<div class="tabs-block">
					...
					<div class="wrap-tabs">
						<div class="tab" id="tab-1">
							<div class="tab__text">
								Плетеная корзина Twigs выполнена из натуральных материалов. Корзинку можно использовать для
								фруктов, как хлебницу Корзины из бамбука доступны к заказу в 3-х разных размерах. Или можно
								купить набор из 3-х корзин со скидкой. Размер: Маленькая: Длина - 16 см, Ширина - 13 см, Высота
								- 5 см Средняя: Длина - 19 см, Ширина - 16 см, Высота - 6 см Большая: Длина - 24 см, Ширина - 20
								см, Высота - 7 см Материал: бамбук Данный товар находится на удаленном складе и отправляется
								только по предоплате. Если у вас корзине есть и другие товары, возможна отправка двумя посылками
								из разных складов.
							</div>
						</div>
						<div class="tab tab-hide" id="tab-2">
							<div class="tab__text">
								Lorem ipsum dolor sit amet consectetur, adipisicing elit. Expedita quam adipisci ea maxime animi
								saepe, enim sunt quos qui consectetur. Ea, dolorum dolores! Quae provident officiis officia
								soluta. Eligendi, ab?
								Recusandae, numquam sit adipisci non error repellendus exercitationem nam consequatur
								voluptatibus doloremque distinctio tempore delectus natus molestiae quia nulla assumenda.
								Doloremque temporibus ipsa at libero, adipisci cupiditate quidem ad architecto.
							</div>
						</div>
						<div class="tab tab-hide" id="tab-3">
							<div class="tab__text">
								Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur quo similique id voluptatem
								harum rerum ratione voluptates enim perferendis veniam, labore adipisci ex, deserunt, saepe
								delectus ea doloremque consectetur sint?
								Asperiores obcaecati error inventore soluta corporis repellat rerum iste voluptas est fugit,
								itaque distinctio dignissimos quibusdam eveniet quisquam? Ad minus laboriosam enim voluptatum
								cum aperiam non necessitatibus ut, aliquam consequuntur.
							</div>
						</div>
					</div>
			...
			<div class="novelties">
				<div class="novelties__row">
					...
					<div class="arow-block">
						<div class="arow-block__arow-left fon-white"><img src="img/arow-block__arow-left-green.png" alt="">
						</div>
						<div class="arow-block__arow-right fon-white"><img src="img/arow-block__arow-right-green.png" alt="">
						</div>
					</div>
				</div>
			...
			<div class="about">
				...
				<div class="about__text">
					...
					<div class="about__text-text category-block__text">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dolor mattis egestas arcu vitae, habitant
							elit. Egestas rhoncus, libero tincidunt integer euismod iaculis netus tristique. Quam sed ultricies
							molestie nullam. Erat non nunc id sed. Cursus lorem mattis sagittis dui ultricies felis erat. Proin
							bibendum aliquam,
						</p>
						<p>Tincidunt morbi nunc donec congue tincidunt est mi non semper. Id id integer amet sit at lectus
							turpis at sed. Nulla mauris curabitur diam, in. In dictumst diam id vel fames. Blandit vulputate
							vel mi nulla. Tempus consectetur donec gravida phasellus. Id justo, volutpat leo pellentesque.
							Aliquam ut ultricies vel sed. Aliquet quisque aliquam nam amet faucibus. Molestie tincidunt est
							etiam vitae orci enim, turpis. Mi nullam tincidunt elit ut.
						</p>
						<p>pellentesque purus. Elementum ac blandit odio massa vestibulum, erat pulvinar sed cursus. Aenean
							eget ullamcorper nisl amet. Nulla tincidunt sagittis, morbi sit rhoncus mattis porttitor ac. Elit
							ultricies sed tincidunt libero feugiat. Augue nulla purus elit ac, leo, eget.
						</p>
					</div>
				</div>
